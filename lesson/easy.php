...
<body oncontextmenu=" return disableRightClick();">
    <div id="wrapper">
        ...
        <div id="main">
            <div id="list">
            <h1 class="q"><font color="#A52A2A">Title:</font> <font color="#98FF98">Challenge 1</font></h1>
            <br><br>
...
<form name="ping" action="easy.php" method="post">
...
?>
            ...
            <div id="data">
                ...
                <img src="../assets/walking.gif" width="130" height="130" alt="trust me" class="logo">
                    <li><a href="../">Home</a></li>
                    <li><a href="medium.php">Challenge 2</a></li>
